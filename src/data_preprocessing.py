...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            logger.error("Error during data preprocessing {e}")
            raise CustomException("Error while preprcoessing", e)
    ...
    def process(self):
        try:
            ...
            logger.error("Error during data processing pipleine {e}")
            raise CustomException("Error while processing data pipleine", e)
