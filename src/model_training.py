...
class ModelTraining():
    ...
    def load_and_split_data(self):
        try:
            ...
            logger.error("Error in loading and splitting data {e}")
            raise CustomException("Falied to load data", e)
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            logger.info("starting Random Search CV for hyperparameter tuning")
            ...
            logger.error("Error in training LightGBM model {e}")
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            logger.error("Error in evaluating model performance {e}")
    ...
    def save_model(self, model):
        try:
            ...
            logger.error("Error in saving model {e}")
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("Starting MLflow experimentations")
