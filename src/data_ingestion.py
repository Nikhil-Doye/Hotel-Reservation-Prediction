...
class DataIngestion:
    def __init__(self, config):
        ...
        logger.info(f"Data ingestion initialized with config: {self.bucket_name} and the file is {self.file_name}")
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.error(f"Error while downloading CSV file from GCP")
